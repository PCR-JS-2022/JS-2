...
1.  Функция ``createGroup`` должна принимать название интереса группы и возвращать объект группы людей, объединенных переданным интересом. Функция должна возвращать объект с 3 методами:
